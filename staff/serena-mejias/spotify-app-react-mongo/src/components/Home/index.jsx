...
class Home extends Component {
  ...
  handleAlbumSelected = albumId => {
    ...
    this.props.history.push(
      `/search/${query}/artist/${artistId}/album/${albumId}`
    );
  };
  ...
  handleTrackSelected = trackId => {
    ...
    const {
      state: { query, artistId, albumId }
    } = this;

    this.props.history.push(
      `/search/${query}/artist/${artistId}/album/${albumId}/track/${trackId}`
    );
  };
  ...
  render() {
    ...
    return (
      <section className="home">
        <Search
          title={i18n[language].searchTitle}
        ...
        />
        <Route
          path="/search/:query/artist/:artistId"
          render={props => (
            <AlbumResults
        ...
        />
        <Route
          path="/search/:query/artist/:artistId/album/:albumId"
          render={props => (
            <TrackResults
        ...
        />
        <Route
          path="/search/:query/artist/:artistId/album/:albumId/track/:trackId"
          render={props => <TrackPlayer trackId={props.match.params.trackId} />}
        />
      </section>
    );
  }
