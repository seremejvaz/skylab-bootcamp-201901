...
describe("user api", () => {
  describe("register", () => {
    ...
    it("should fail when surname is a number", () => {
      expect(() => userApi.register(name, 1, username, password)).to.throw(Error, 
        `1 is not a string`
      );
    });

    it("should fail on empty surname", () => {
      expect(() => userApi.register(name, "", username, password)).to.throw(Error, 
        "surname is empty"
      );
    });
    ...
    it("should fail on empty username", () => {
      expect(() => userApi.register(name, surname, "", password)).to.throw(Error, 
        "username is empty"
      );
    });
    ...
    it("should fail on empty password", () => {
      expect(() => userApi.register(name, surname, username, "")).to.throw(Error, 
        "password is empty"
      );
    });
  });
  ...
  describe("authenticate", () => {
    ...
    it("should fail when username is a boolean", () => {
      expect(() => userApi.authenticate(true, password)).to.throw(Error, 
        `true is not a string`
      );
    });

    it("should fail when username is empty", () => {
      expect(() => userApi.authenticate("", password)).to.throw(Error, 
        `username is empty`
      );
    });

    it("should fail when password is an array", () => {
      expect(() => userApi.authenticate(username, [1, 2, 3])).to.throw(Error, 
        `1,2,3 is not a string`
      );
    });

    it("should fail when password is empty", () => {
      expect(() => userApi.authenticate(username, "")).to.throw(Error, 
        `password is empty`
      );
    });
  });
  ...
  describe("retrieve", () => {
    ...
    it("should fail when id is a number", () => {
      expect(() => userApi.retrieve(1, _token)).to.throw(Error, 
        `1 is not a string`
      );
    });

    it("should fail when token is a boolean", () => {
      expect(() => userApi.retrieve(_id, true)).to.throw(Error, 
        `true is not a string`
      );
    });
  });
  ...
  describe("update", () => {
    ...
    it("should fail on empty id", () => {
      expect(() => userApi.update("", _token, data)).to.throw(Error, 
        "id is empty"
      );
    });

    it("should fail on empty token", () => {
      expect(() => userApi.update(_id, "", data)).to.throw(Error, 
        "token is empty"
      );
    });

    it("should fail on empty data", () => {
      expect(() => userApi.update(_id, _token, "")).to.throw(Error, 
        "data is empty"
      );
    });

    it("should fail when id is a number", () => {
      expect(() => userApi.update(1, _token, data)).to.throw(Error, 
        `1 is not a string`
      );
    });

    it("should fail when token is a boolean", () => {
      expect(() => userApi.update(_id, true, data)).to.throw(Error, 
        `true is not a string`
      );
    });

    it("should fail on array as data", () => {
      expect(() => userApi.update(_id, _token, [1, 2, 3])).to.throw(Error, 
  ...
  describe("remove", () => {
    ...
    it("should fail on empty id", () => {
      expect(() => userApi.remove("", _token, username, password)).to.throw(Error, 
        "id is empty"
      );
    });

    it("should fail on empty token", () => {
      expect(() => userApi.remove(_id, "", username, password)).to.throw(Error, 
        "token is empty"
      );
    });

    it("should fail on empty username", () => {
      expect(() => userApi.remove(_id, _token, "", password)).to.throw(Error, 
        "username is empty"
      );
    });

    it("should fail on empty password", () => {
      expect(() => userApi.remove(_id, _token, username, "")).to.throw(Error, 
        "password is empty"
      );
    });

    it("should fail when username is a boolean", () => {
      expect(() => userApi.remove(_id, _token, true, password)).to.throw(Error, 
        `true is not a string`
      );
    });
    ...
    it("should fail when password is an array", () => {
      expect(() =>
        userApi.remove(_id, _token, username, [1, 2, 3])
      ).to.throw(Error, `1,2,3 is not a string`);
    });

    it("should fail when id is a number", () => {
      expect(() => userApi.remove(1, _token, username, password)).to.throw(Error, 
        `1 is not a string`
      );
    });
