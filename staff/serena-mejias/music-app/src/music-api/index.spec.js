...
describe("music api", () => {
  ...
  describe("authenticate user", () => {
    ...
    it("should succeed on correct data", () =>
      musicApi.authenticateUser(email, password).then(({ id, token }) => {
  ...
  describe("retrieve user", () => {
    ...
    it("should succeed on correct data", () =>
      musicApi.retrieveUser(userId, token).then(user => {
  ...
  false &&
    describe("remove user", () => {
      ...
      it("should succeed on correct data", () => {
        return musicApi
          .remove(userId, token, email, password, passwordConfirm)
          .then(() => musicApi.retrieveUser(userId, token))
          .then(() => {
  ...
  false &&
    describe("retrieve artist", () => {
      it("should succeed on mathing query", () => {
        ...
        return musicApi.retrieveArtist(artistId).then(({ id, name }) => {
  ...
  describe("list comments from artist", () => {
    ...
    it("should succeed on mathing query", () =>
      musicApi.listCommentsFromArtist(token, artistId).then(comments => {
